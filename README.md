...
| [<img src="experiments/lemonade-wars/docs/screenshot.png" width="200" alt="Lemonade Wars game screen">](experiments/lemonade-wars/) | **[Lemonade Wars](experiments/lemonade-wars/)** — a beverage-empire business simulation that blends Lemonade Stand's recipe economics with Drug Wars' travelling commodity markets: a deterministic day-cycle simulation core (per-district prices, demand, finance, random events), a responsive Pygame UI that adapts to phones and laptops, and a pygbag build that runs in the browser from GitHub Pages. |
